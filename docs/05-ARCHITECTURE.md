...
> Статус: ✅ утверждён владельцем 2026-06-12. Прошёл краш-тест (3 проверки: сценарии/экраны/решения vs схема).
...
```
Физическое хранилище: **Supabase Storage** (тот же проект, что и БД). RLS-политики на бакеты — файлы организации видят только её участники.
