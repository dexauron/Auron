...
def _add_dv(ws, formula, cell_ref):
...
def build_vvod_rashody(ws):
    ...
    _add_dv(ws, '"' + ",".join(c for c in CATS_EXPENSE if c != "Оплата ТП" or True) + '"', "B6")
