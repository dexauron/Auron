...
-- ⚠ Перед запуском впиши свои email в ОБНОВЛЕНИИ-6 и -7, если отличаются
--   от заготовок (dexauron@gmail.com / manager@ / staff@).
-- ═══════════════════════════════════════════════════════════════
...
-- ═══════════════ ОБНОВЛЕНИЕ-16 ═══════════════
-- Анонимный учёт популярности (какие товары чаще открывают, что ищут) — только
-- обезличенные счётчики, без сохранения личности.
...
-- ═══════════════ ОБНОВЛЕНИЕ-17 ═══════════════
-- «Ходовые товары» по выручке (деньгам), а не по смешанному количеству.
