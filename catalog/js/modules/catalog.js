 ...
 *
 * Сначала отсюда же считалась цена за килограмм и литр, как в больших
 * магазинах. Владелец её убрал (29.08): на штучном товаре она чаще путала,
 * чем помогала — «1 143 ₽/кг» под жвачкой за 4 ₽ читается как ошибка.
 * Сам разбор остался: из него берётся фасовка отдельной строкой. */
