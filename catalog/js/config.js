...
window.CATALOG_CONFIG = {
  ...
  // Служебный email аккаунта сотрудников: сотрудник вводит только пароль магазина.
  // Аккаунт создаёт владелец в Supabase: Authentication → Users (см. setup/ОБНОВЛЕНИЕ-2.sql)
