...
for mi,mon in enumerate(month_names_short,1):
    r=mi+1
    start_d=f"DATE(ДАШБОРД!$E$4,{mi},1)"
    end_d=f"EOMONTH(DATE(ДАШБОРД!$E$4,{mi},1),0)"
...
for mi,mon in enumerate(month_names_short,1):
    r=70+mi
    start_d=f"DATE(ДАШБОРД!$E$4,{mi},1)"; end_d=f"EOMONTH(DATE(ДАШБОРД!$E$4,{mi},1),0)"
    ws_d.cell(r,1).value=mon
...
v_days = '=IFERROR(SUMPRODUCT((БАЗА_ДДС!$A$4:$A$3003>=ДАШБОРД!$A$5)*(БАЗА_ДДС!$A$4:$A$3003<=ДАШБОРД!$B$5)*(БАЗА_ДДС!$D$4:$D$3003="Доход")*(БАЗА_ДДС!$G$4:$G$3003<>"")*(1/COUNTIFS(БАЗА_ДДС!$A$4:$A$3003,БАЗА_ДДС!$A$4:$A$3003,БАЗА_ДДС!$D$4:$D$3003,"Доход"))),0)'
p_days = '=IFERROR(SUMPRODUCT((БАЗА_ДДС!$A$4:$A$3003>=ДАШБОРД!$C$5)*(БАЗА_ДДС!$A$4:$A$3003<=ДАШБОРД!$D$5)*(БАЗА_ДДС!$D$4:$D$3003="Доход")*(БАЗА_ДДС!$G$4:$G$3003<>"")*(1/COUNTIFS(БАЗА_ДДС!$A$4:$A$3003,БАЗА_ДДС!$A$4:$A$3003,БАЗА_ДДС!$D$4:$D$3003,"Доход"))),0)'
...
p_cnt_smeny = '=IFERROR(SUMPRODUCT((БАЗА_ДДС!$A$4:$A$3003>=ДАШБОРД!$C$5)*(БАЗА_ДДС!$A$4:$A$3003<=ДАШБОРД!$D$5)*(БАЗА_ДДС!$D$4:$D$3003="Доход")*(БАЗА_ДДС!$G$4:$G$3003<>"")*(1)),0)'
p_выр_смену = f'=IFERROR(({p_выручка[1:]})/MAX(1,{p_cnt_smeny[1:]}),0)'

v_макс_день = '=IFERROR(MAXIFS(БАЗА_ДДС!$G$4:$G$3003,БАЗА_ДДС!$A$4:$A$3003,">="&ДАШБОРД!$A$5,БАЗА_ДДС!$A$4:$A$3003,"<="&ДАШБОРД!$B$5,БАЗА_ДДС!$D$4:$D$3003,"Доход"),0)'
p_макс_день = '=IFERROR(MAXIFS(БАЗА_ДДС!$G$4:$G$3003,БАЗА_ДДС!$A$4:$A$3003,">="&ДАШБОРД!$C$5,БАЗА_ДДС!$A$4:$A$3003,"<="&ДАШБОРД!$D$5,БАЗА_ДДС!$D$4:$D$3003,"Доход"),0)'
...
p_расх_кол = '=IFERROR(SUMPRODUCT((БАЗА_ДДС!$A$4:$A$3003>=ДАШБОРД!$C$5)*(БАЗА_ДДС!$A$4:$A$3003<=ДАШБОРД!$D$5)*(БАЗА_ДДС!$D$4:$D$3003="Расхождение")*(БАЗА_ДДС!$G$4:$G$3003<>"")*(1)),0)'
v_kasса_ост = '=IFERROR(SUMPRODUCT((БАЗА_ДДС!$A$4:$A$3003>=ДАШБОРД!$A$5)*(БАЗА_ДДС!$A$4:$A$3003<=ДАШБОРД!$B$5)*(БАЗА_ДДС!$D$4:$D$3003="Касса")*БАЗА_ДДС!$G$4:$G$3003),0)'
p_kasса_ост = '=IFERROR(SUMPRODUCT((БАЗА_ДДС!$A$4:$A$3003>=ДАШБОРД!$C$5)*(БАЗА_ДДС!$A$4:$A$3003<=ДАШБОРД!$D$5)*(БАЗА_ДДС!$D$4:$D$3003="Касса")*БАЗА_ДДС!$G$4:$G$3003),0)'

# Debt
v_долг_тек = '=IFERROR(НАСТРОЙКИ!E9+SUMPRODUCT((БАЗА_ДДС!$A$4:$A$3003<=ДАШБОРД!$B$5)*(БАЗА_ДДС!$D$4:$D$3003="Долг")*БАЗА_ДДС!$G$4:$G$3003)-SUMPRODUCT((БАЗА_ДДС!$A$4:$A$3003<=ДАШБОРД!$B$5)*(БАЗА_ДДС!$D$4:$D$3003="Оплата долга")*БАЗА_ДДС!$G$4:$G$3003),0)'
p_долг_тек = '=IFERROR(НАСТРОЙКИ!E9+SUMPRODUCT((БАЗА_ДДС!$A$4:$A$3003<=ДАШБОРД!$D$5)*(БАЗА_ДДС!$D$4:$D$3003="Долг")*БАЗА_ДДС!$G$4:$G$3003)-SUMPRODUCT((БАЗА_ДДС!$A$4:$A$3003<=ДАШБОРД!$D$5)*(БАЗА_ДДС!$D$4:$D$3003="Оплата долга")*БАЗА_ДДС!$G$4:$G$3003),0)'
...
# Operations
v_просроч = '=IFERROR(SUMPRODUCT((ЗАПИСЬ_НА_ВЫПЛАТУ!$B$4:$B$503>=ДАШБОРД!$A$5)*(ЗАПИСЬ_НА_ВЫПЛАТУ!$B$4:$B$503<=ДАШБОРД!$B$5)*(ЗАПИСЬ_НА_ВЫПЛАТУ!$E$4:$E$503="Просрочено")*ЗАПИСЬ_НА_ВЫПЛАТУ!$D$4:$D$503),0)'
p_просроч = '=IFERROR(SUMPRODUCT((ЗАПИСЬ_НА_ВЫПЛАТУ!$B$4:$B$503>=ДАШБОРД!$C$5)*(ЗАПИСЬ_НА_ВЫПЛАТУ!$B$4:$B$503<=ДАШБОРД!$D$5)*(ЗАПИСЬ_НА_ВЫПЛАТУ!$E$4:$E$503="Просрочено")*ЗАПИСЬ_НА_ВЫПЛАТУ!$D$4:$D$503),0)'
v_просроч_кол = '=IFERROR(SUMPRODUCT((ЗАПИСЬ_НА_ВЫПЛАТУ!$B$4:$B$503>=ДАШБОРД!$A$5)*(ЗАПИСЬ_НА_ВЫПЛАТУ!$B$4:$B$503<=ДАШБОРД!$B$5)*(ЗАПИСЬ_НА_ВЫПЛАТУ!$E$4:$E$503="Просрочено")*(ЗАПИСЬ_НА_ВЫПЛАТУ!$D$4:$D$503<>"")*(1)),0)'
p_просроч_кол = '=IFERROR(SUMPRODUCT((ЗАПИСЬ_НА_ВЫПЛАТУ!$B$4:$B$503>=ДАШБОРД!$C$5)*(ЗАПИСЬ_НА_ВЫПЛАТУ!$B$4:$B$503<=ДАШБОРД!$D$5)*(ЗАПИСЬ_НА_ВЫПЛАТУ!$E$4:$E$503="Просрочено")*(ЗАПИСЬ_НА_ВЫПЛАТУ!$D$4:$D$503<>"")*(1)),0)'
v_vypl_plan = '=IFERROR(SUMPRODUCT((ЗАПИСЬ_НА_ВЫПЛАТУ!$B$4:$B$503>=ДАШБОРД!$A$5)*(ЗАПИСЬ_НА_ВЫПЛАТУ!$B$4:$B$503<=ДАШБОРД!$B$5)*ЗАПИСЬ_НА_ВЫПЛАТУ!$D$4:$D$503),0)'
v_vypl_fakt = '=IFERROR(SUMPRODUCT((ЗАПИСЬ_НА_ВЫПЛАТУ!$B$4:$B$503>=ДАШБОРД!$A$5)*(ЗАПИСЬ_НА_ВЫПЛАТУ!$B$4:$B$503<=ДАШБОРД!$B$5)*(ЗАПИСЬ_НА_ВЫПЛАТУ!$E$4:$E$503="Выплачено")*ЗАПИСЬ_НА_ВЫПЛАТУ!$D$4:$D$503),0)'
v_vypl_pct = f'=IFERROR(({v_vypl_fakt[1:]})/MAX(1,({v_vypl_plan[1:]}))*100,0)'
p_vypl_pct = '=50'  # placeholder for previous
v_zakup_dolg = '=IFERROR(SUMPRODUCT((БАЗА_ДДС!$A$4:$A$3003>=ДАШБОРД!$A$5)*(БАЗА_ДДС!$A$4:$A$3003<=ДАШБОРД!$B$5)*(БАЗА_ДДС!$E$4:$E$3003="Закуп товара")*(БАЗА_ДДС!$F$4:$F$3003="Долг")*БАЗА_ДДС!$G$4:$G$3003),0)'
p_zakup_dolg = '=IFERROR(SUMPRODUCT((БАЗА_ДДС!$A$4:$A$3003>=ДАШБОРД!$C$5)*(БАЗА_ДДС!$A$4:$A$3003<=ДАШБОРД!$D$5)*(БАЗА_ДДС!$E$4:$E$3003="Закуп товара")*(БАЗА_ДДС!$F$4:$F$3003="Долг")*БАЗА_ДДС!$G$4:$G$3003),0)'
...
v_макс = v_макс_день
v_мин = '=IFERROR(MINIFS(БАЗА_ДДС!$G$4:$G$3003,БАЗА_ДДС!$A$4:$A$3003,">="&ДАШБОРД!$A$5,БАЗА_ДДС!$A$4:$A$3003,"<="&ДАШБОРД!$B$5,БАЗА_ДДС!$D$4:$D$3003,"Доход"),0)'
