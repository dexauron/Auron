---
name: mobile-design
description: "Design mobile-first, touch-first interfaces that respect platform conventions. Use when building or reviewing UI for phones and tablets — touch target sizes, thumb-reachable layouts, gestures, safe areas, battery-conscious and offline-capable patterns. Trigger on 'mobile layout', 'touch targets', 'works on phone', or adapting a desktop screen for mobile."
risk: unknown
source: community
