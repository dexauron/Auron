...
description: Правила Remotion — с чего начинать любую работу с видео. Обязательно используй, когда владелец просит сделать РОЛИК, видео, рекламу магазина, сторис, Reels, заставку или анимированную заготовку, а также при любой правке уже существующего видео-проекта. Это распорядитель: с него начинаем, он отправляет к нужному соседнему скилу.
version: 4.0.505
---
