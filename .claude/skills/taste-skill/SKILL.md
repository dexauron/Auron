---
name: taste-skill
description: Против «шаблонного» вида — чтобы экран не выглядел сгенерированным по одному лекалу. Используй для ЛЕНДИНГОВ, страниц-визиток, экрана входа, приглашения сотрудника, пустых состояний и «первого впечатления», а также когда владелец говорит «выглядит как у всех», «скучно», «дёшево», «сделай красиво». ВАЖНО: автор прямо пишет, что скил НЕ для панелей, таблиц и многошагового рабочего интерфейса — для наших рабочих экранов (Касса, Товары, Поставщики, Журнал) бери impeccable, а не этот.
---

> **Врезка проекта Auron (не от автора скила).** Взяты только знания,
> скрипт-реестр автора не копировался.
>
> Важное ограничение, о котором автор пишет сам и которое легко упустить:
> этот скил — для лендингов, портфолио и редизайнов, и ПРЯМО не для
> панелей, таблиц и рабочего интерфейса. Auron — как раз рабочий
> интерфейс. Поэтому здесь он уместен на входе, приглашении, пустых
> состояниях и «первом впечатлении»; для Кассы, Товаров, Поставщиков и
> Журнала правильный инструмент — `impeccable`.
