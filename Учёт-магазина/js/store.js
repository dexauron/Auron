...
(function (root, factory) {
  ...
  var DEFAULT_SETTINGS = {
    ...
    /* finSources («Откуда берут деньги»: из ящика, из сейфа, со счёта)
       убрана. Это осталось от старой задумки, когда источник денег был
       строкой. Теперь эту работу делают счета — в форме расхода стоит поле
       «С какого счёта», и оно единственное. Две правды об источнике денег
       хуже одной: остатки начинают расходиться, и непонятно, какой верить. */
    finCashiers: '',
    finShifts: 'День, Ночь',
