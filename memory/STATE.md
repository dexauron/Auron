...
- Офлайн-ввод (путь A) СДЕЛАН и влит в ветку приложения (aa20e4c): очередь offline-queue.js,
  автоотправка при связи, индикатор. Утверждено в docs (DECISIONS + 05-ARCHITECTURE). Кэш v52.
  Осталось: сквозная проверка в браузере на устройстве. Пути B/C — на будущее.
