...
(function (root, factory) {
  ...
  var DEFAULT_SETTINGS = {
    ...
    openSbpStart: 0,        // начальный остаток по СБП
    ...
    keepBackups: 30, backupEveryHours: 24,        // сколько копий базы хранить в папке «копии»
    ...
    theme: 'Авто', themeDayFrom: '07:00', themeNightFrom: '20:00', bigText: 'нет', privacyDefault: 'нет',
  ...
  var COLLECTIONS = ['shifts', 'invoices', 'payments', 'expenses', 'timesheet', 'payouts', 'expiry',
    ...
    // сохранённые наборы фильтров («мой понедельник»), свои показатели
    // и скрытые значения справочников
    'filtersets', 'kpis', 'dictoff',
  ...
  var COLL_RU = {
    ...
    staff: 'Сотрудники', dictoff: 'Скрытое в справочниках',
